...
import com.example.kmm_sample.android.imagedetails.ImageDetailsScreen
import com.example.kmm_sample.android.imagedetails.ImageDetailsUiState
import com.example.kmm_sample.android.imagedetails.ImageDetailsViewModel
import com.example.kmm_sample.android.imageslist.ImagesListScreen
...
object AppScreens {
    ...
    const val IMAGE_DETAILS_PATH = "image_details/{imageId}"
}
            ...
            TopAppBar(
                ...
                actions = {
                    if (
                        ...
                        val imageData =
                            (imageDetailsUiState.value as ImageDetailsUiState.Success).imageData
